...
annotation_file = r'D:\ks\human\MTCNN-Pytorch-master\anno_store\imglist_anno_12.txt'
model_store_path = r'D:\ks\human\MTCNN-Pytorch-master\model_store'
end_epoch = 11
frequent = 100
lr = 0.01
lr_epoch_decay = [9]
...
if __name__ == '__main__':
    ...
    train_net(annotation_file, model_store_path,
                end_epoch, frequent, lr, lr_epoch_decay,batch_size, use_cuda=True)