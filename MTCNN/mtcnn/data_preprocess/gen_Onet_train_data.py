...
prefix_path = r"D:\ks\human\MTCNNdata_set\face_detection\WIDER_train\images\\"
traindata_store = r'D:\ks\human\MTCNN\data_set\train\\'
pnet_model_file = r'D:\ks\human\MTCNNmodel_store\pnet.pt'
rnet_model_file = r'D:\ks\human\MTCNN\model_store\rnet.pt'
annotation_file = r'D:\ks\human\MTCNN\anno_store\anno_train.txt'
use_cuda = True
...
def gen_onet_sample_data(data_dir,anno_file,det_boxs_file,prefix):
    ...
    save_path = r'D:\ks\human\MTCNN\anno_store'
    if not os.path.exists(save_path):
